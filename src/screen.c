...
#if defined(__vita__)
consvar_t cv_scr_width = {"scr_width", "960", CV_SAVE, CV_Unsigned, NULL};
consvar_t cv_scr_height = {"scr_height", "544", CV_SAVE, CV_Unsigned, NULL};
consvar_t cv_scr_depth = {"scr_depth", "32 bits", CV_SAVE, scr_depth_cons_t, NULL};
#else
